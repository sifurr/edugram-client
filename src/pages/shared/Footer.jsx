            ...
            <footer className="bg-white dark:bg-gray-900">
                ...
                >
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <div className="text-teal-600 dark:text-teal-300">
                                <div>
                                    <img className="h-20 w-20 dark:bg-neutral-300 rounded-full" src={logo} alt="" />
                                </div>
                            </div>

                            <p className="mt-4 max-w-xs text-gray-500 dark:text-gray-400">
                                Edugram is an online learning platform. Here you can many courses to enhance your skill.
                            </p>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                        &copy; {new Date().getFullYear()}. Edugram. All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
